...
export const LinkPreview = ({
	...
	if (data && (data.mediaType === 'image' || href.includes('i.imgur.com')))
		return <img loading="lazy" src={data.url} style={{ width: '100%' }} />;
	return (
		<>
			{data && (
				<Box aria-hidden={true} sx={{ width: '100%' }}>
					...
					{dataDescription && (
						<Typography textOverflow="clip">{dataDescription}</Typography>
					)}
				</Box>
			)}
