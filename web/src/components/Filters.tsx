...
export function Filters() {
    ...
    return <FiltersWrapper>
        <FiltersContainer onSubmit={handleSubmit} action="none">
            ...
            />
            <TextField error={state.error} name="username" label="Usuario o id:123" variant="filled" autoComplete="off" defaultValue={state.currentUsername} autoFocus={state.currentChannel !== null && state.currentUsername === null} />
